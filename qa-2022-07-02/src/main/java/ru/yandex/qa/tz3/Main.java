...
import ru.yandex.qa.tz3.task.TaskStatus;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task task = new Task("Task 1", TaskStatus.NEW, "описание таски 1");
        Task tas2 = new Task("Task 2", TaskStatus.IN_PROGRESS, "описание таски 2");

        taskManagerService.addTask(task);
        taskManagerService.addTask(tas2);

        Epic epic = new Epic("Epic 1", TaskStatus.NEW, "описание 1-ого эпика");
        Epic epic2 = new Epic("Epic 2", TaskStatus.NEW, "описание 2-ого эпика");

        taskManagerService.addEpic(epic);
        taskManagerService.addEpic(epic2);

        SubTask subTask = new SubTask("SubTask 1", TaskStatus.IN_PROGRESS, "описание 1", epic.getId());
        SubTask subTask2 = new SubTask("SubTask 2", TaskStatus.IN_PROGRESS, "описание 2", epic2.getId());
